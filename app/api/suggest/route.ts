...
O "angulo" é o ponto MAIS importante: escrito NA VOZ DA NATHALIA — calmo, firme, breve; palavrão só se carregar emoção real, nunca gratuito; frase quebrada, como ELA FALARIA na frente da câmera. É a PROVOCAÇÃO, não a descrição.
...
- CERTO: a frase que sai da boca dela. Ex: "Quem te disse que agachar mais ia resolver o teu glúteo?" / "Você não tá estagnada. Você tá repetindo o treino errado há 1 ano." Imite ESSA pegada.

Cada pauta: tema curto + o angulo (a provocação na voz da Nathalia) + de qual pilar nasce.
